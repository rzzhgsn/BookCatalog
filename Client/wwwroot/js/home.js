...
function detail(stringUrl, key) {
    $.ajax({
        ...
        text += `
               ...
               <li><b>Rating</b>          : ${rate}</li>
               <li><b>Synopsis</b>        : ${synopsis}</li>
               <li><b>Page Number</b>     : ${pageNumber}</li>
               <li><b>Genre</b>           : ${genre}</li>
               <li><b>Website Url</b>     : </li>
               <a href="${tokped}" target="_blank" ><img src="https://www.freepnglogos.com/uploads/logo-tokopedia-png/berita-tokopedia-info-berita-terbaru-tokopedia-6.png" width="80" /></a>
               <a href="${shopee}" target="_blank" ><img src="https://www.freepnglogos.com/uploads/shopee-logo-png/shopee-logo-shop-with-the-gentlemen-collection-and-win-the-shopee-0.png" width="80" /></a>
               <a href="${lazada}" target="_blank" ><img src="https://seeklogo.com/images/L/lazada-logo-D8D78A9569-seeklogo.com.png" width="80" /></a>
               </ul>
                `;
